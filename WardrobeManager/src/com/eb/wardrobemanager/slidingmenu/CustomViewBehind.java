package com.eb.wardrobemanager.slidingmenu;

import com.eb.wardrobemanager.R;
import com.eb.wardrobemanager.slidingmenu.SlidingMenu.CanvasTransformer;
...
public class CustomViewBehind extends ViewGroup {
	...
	public void drawSelector(View content, Canvas canvas, float openPercent) {
		...
		if (mSelectorDrawable != null && mSelectedView != null) {
			String tag = (String) mSelectedView.getTag(R.id.tv_hello);
	...
	public void setSelectedView(View v) {
		if (mSelectedView != null) {
			mSelectedView.setTag(R.id.tv_hello, null);
			mSelectedView = null;
		}
		if (v != null && v.getParent() != null) {
			mSelectedView = v;
			mSelectedView.setTag(R.id.tv_hello, TAG+"SelectedView");
			invalidate();
		}
	}
